...
Redmine::MenuManager.map :project_menu do |menu|
 ...
 # menu.push :activity, { :controller => 'activities', :action => 'index' },  :if => Proc.new { User.current.admin? }, :last => true, :caption => :label_project_plural
  menu.push :roadmap, { :controller => 'versions', :action => 'index' }, :param => :project_id,
              :if => Proc.new { |p| p.shared_versions.any? }
  menu.push :issues, { :controller => 'issues', :action => 'index' }, :param => :project_id, :caption => "Product Backlogs"
