...
ActiveRecord::Schema.define(:version => 20121018132257) do
  ...
  add_index "attendances", ["story_id"], :name => "index_attendances_on_story_id"
  ...
  create_table "tasks", :force => true do |t|
    ...
    t.datetime "created_at",                                 :null => false
    t.datetime "updated_at",                                 :null => false
    t.date     "last_mail",        :default => '2012-10-23'
    t.boolean  "status"
    t.string   "issue_id"
