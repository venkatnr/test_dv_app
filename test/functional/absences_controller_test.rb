...
class AbsencesControllerTest < ActionController::TestCase
  ...
  test "should create absence" do
    assert_difference('Absence.count') do
      post :create, absence: { date_of_joining: @absence.date_of_joining, emp_name: @absence.emp_name, employee_id: @absence.employee_id, group: @absence.group, no_of_hours: @absence.no_of_hours, user_id: @absence.user_id }
    end
  ...
  test "should update absence" do
    put :update, id: @absence, absence: { date_of_joining: @absence.date_of_joining, emp_name: @absence.emp_name, employee_id: @absence.employee_id, group: @absence.group, no_of_hours: @absence.no_of_hours, user_id: @absence.user_id }
    assert_redirected_to absence_path(assigns(:absence))
  end
